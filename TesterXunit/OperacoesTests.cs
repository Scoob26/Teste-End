using TesteCore;
using Xunit; // Importa o framework de testes "Xunit", usado para criação e execução de testes.

namespace TesterXUnit // Define o namespace "TesterXUnit" para organizar o código de teste.
{
